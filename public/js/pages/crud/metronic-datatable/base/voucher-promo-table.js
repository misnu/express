						...
						<div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="../../pages/promo/edit_voucher.html"><i class="la la-edit"></i> Edit</a>\
								<a class="dropdown-item" href="#" data-target="#kt_modal_1"><i class="la la-remove"></i> Delete</a>\
						  	</div>\
						</div>\
					';
					},
