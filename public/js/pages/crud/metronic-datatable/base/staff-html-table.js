						...
						<div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="../../pages/staff/staff_detail.html"><i class="la la-info"></i> Staff Detail</a>\
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_1"><i class="la la-user-times"></i> Delete Staff</a>\
						  	</div>\
						</div>\
