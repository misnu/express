...
var KTDatatableHtmlTableDemo = function() {
		...
		var datatable = $('.kt-datatable').KTDatatable({
			...
			columns: [
                ...
                },
                {
					...
					// 	    	<a class="dropdown-item" href="edit_product.html"><i class="la la-edit"></i> Edit</a>\
					// 			<a class="dropdown-item" href="/delete_product/1"><i class="la la-remove"></i> Delete</a>\
					// 	  	</div>\
					// 	</div>\
    ...
    $('#kt_form_status').on('change', function() {
	  datatable.search($(this).val().toLowerCase(), 'Category','Price','Status');
	...
	$('#status').on('change', function(data) {
		...
		var data = 	$(this).is(':checked') ? 'checked' : 'unchecked'; 
		console.log(data);
	  });
