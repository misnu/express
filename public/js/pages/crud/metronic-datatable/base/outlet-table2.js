						...
						<div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="edit_staff.html"><i class="la la-edit"></i> Edit Staff</a>\
						    	<a class="dropdown-item" href="detail_staff.html"><i class="la-info"></i> Detail Staff</a>\
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_1"><i class="la-user-times"></i> Delete Staff</a>\
						  	</div>\
						</div>\
