						...
						<div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="edit_staff.html"><i class="la la-plus-circle"></i> Add to Product</a>\
						    	<a class="dropdown-item" href="../../pages/products/edit_additional_product.html"><i class="la la-edit"></i> Edit</a>\
